...
private function initallizeAsStartup(Service service,Method method)
{
Class cls=service.getClassReference();
...
private function scanParams(Service service)
{
...
private function initallizeAsService(Service service,Method method)
{
Path methodPath;
Class cls=service.getClassReference();
...
{
initallizeAsStartup(service,method);
}
else
{
initallizeAsService(service,method);
}
