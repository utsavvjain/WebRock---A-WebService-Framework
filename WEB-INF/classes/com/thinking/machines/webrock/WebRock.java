...
reqParameters.put(paramName,request.getParameter(paramName));
}
...
{
reqParam=reqParameters.get(injectRequestParameter.value());
...
reqParam=reqParameters.get(requestParam.getPropertyName());
